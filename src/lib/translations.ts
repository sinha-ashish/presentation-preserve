...
const fr: Translation = {
  ...
  instinct: {
    ...
    cards: [
      ...
      { tag: "Décision de ne pas construire", headline: "Le cas d'usage que j'ai arrêté avant qu'il ne parte en production.", body: "J'ai cadré un agent IA centralisé pour le monitoring des performances d'infrastructure et les tableaux de bord de conformité — la vision couvrait l'analyse de tendances historiques, des recommandations de correction active et des corrections semi-automatisées en un clic sur ServiceNow, ScienceLogic, l'analyse de logs, et les audits de sécurité et d'accessibilité. La complexité d'intégration des données entre des systèmes disparates était trop élevée pour justifier la poursuite du projet. Je l'ai mis en pause, redirigé l'équipe, et maintenu une squad dédiée de trois ingénieurs pour explorer la faisabilité en parallèle — pendant que le reste du portefeuille continuait à livrer. Ce cas d'usage côtoie 15+ cas d'usage déjà confirmés en production, sans être comptabilisé dans ce chiffre.", closing: "Savoir quoi ne pas construire — et quand s'arrêter — c'est le même muscle que savoir quoi livrer en premier." },
    ],
  },
  manual: {
